...
func would_overlap(board) -> bool:
	...
	return (board[cell.x][cell.y] != Globals.SlidePuzzleValues.Empty and
			board[cell.x + 1][cell.y] != Globals.SlidePuzzleValues.Empty and
			board[cell.x][cell.y + 1] != Globals.SlidePuzzleValues.Empty and
...
func can_move_right(board) -> bool:
	if cell.x < board.size() - 2:
		return (board[cell.x + 2][cell.y] == Globals.SlidePuzzleValues.Empty and
				board[cell.x + 2][cell.y + 1] == Globals.SlidePuzzleValues.Empty)
	
	return false

func can_move_down(board) -> bool:
	if cell.y < board[0].size() - 2:
		return (board[cell.x][cell.y + 2] == Globals.SlidePuzzleValues.Empty and
				board[cell.x + 1][cell.y + 2] == Globals.SlidePuzzleValues.Empty)
...
func move_right(board) -> void:
	...
	board[cell.x + 2][cell.y + 1] = indicator
...
func move_down(board) -> void:
	...
	board[cell.x + 1][cell.y + 2] = indicator
